...
class AsignaturasControllerTest < ActionController::TestCase
  ...
  test "should create asignatura" do
    assert_difference('Asignatura.count') do
      post :create, asignatura: { codigo: @asignatura.codigo, descripcion: @asignatura.descripcion, docente_id: @asignatura.docente_id, nombre: @asignatura.nombre }
    end
  ...
  test "should update asignatura" do
    patch :update, id: @asignatura, asignatura: { codigo: @asignatura.codigo, descripcion: @asignatura.descripcion, docente_id: @asignatura.docente_id, nombre: @asignatura.nombre }
    assert_redirected_to asignatura_path(assigns(:asignatura))
  end
